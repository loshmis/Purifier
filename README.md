...
The HTMLPurifier Service Provider can be installed via [Composer](http://getcomposer.org) by requiring the `mews/purifier` package and setting the `minimum-stability` to `dev` (required for Laravel 5) in your
